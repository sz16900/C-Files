...
a similar key to the one previously generated, it will produce a second key
(a doublehash). Then, the program will read a second file to check the average times
