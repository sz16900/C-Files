...
int main(void){
  ...
  Queue q;
  char puzzle[TILE][TILE] =  {"203", "146", "758"};
  char original[TILE][TILE] =  {"203", "146", "758"}; /*needs to be updated to next array elem*/
...
while(end == 0){
  ...
  /*update the original*/
    ...
    if(original[0][0]=='1' && original[0][1]=='2' && original[0][2]=='3' &&
            original[1][0]=='4' && original[1][1]=='5' && original[1][2]=='6' &&
            original[2][0]=='7' && original[2][1]=='8'){
              end = end + 1;
            }
}
